                ...
                else
                {
                    ...
                    if (start < minValue)
                    {
                        throw new FormatException(
                            $"'{start} is lower than the minimum allowable value for this field. Value must be between {_impl.MinValue} and {_impl.MaxValue} (all inclusive)."
                            );
                    }
                    ...
                    {
                        throw new FormatException(
                            $"'{end} is higher than the maximum allowable value for this field. Value must be between {_impl.MinValue} and {_impl.MaxValue} (all inclusive)."
                        );
                    }
                }
            }
